...
func main() {
	...
	flag.StringVar(&hostname, "hostname", "", "The node name which you want to watch.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "151f04b2.jike.com",
	})
	if err != nil {
	...
	if err = (&controllers.NodeOPReconciler{
		HostName: hostname,
		Client:   mgr.GetClient(),
		Log:      ctrl.Log.WithName("controllers").WithName("NodeOP"),
